...
function ImageGrid() {
    ...
    const [len_ques, getLenQues] = useState([]);
    ...
    const fetchData = async () => {
        try {
            ...
            getLenQues(responseData.lenQues)
    ...
    const numBins = 15
    const binSize = Math.ceil((Math.max(...len_ques) - Math.min(...len_ques)) / numBins);
    const histogramData = [];
    let minValue = Math.min(...len_ques);

    for (let i = 0; i < numBins; i++) {
        const binStart = minValue + i * binSize;
        const binEnd = Math.min(minValue + (i + 1) * binSize, Math.max(...len_ques));
                ...
                <div class="container my-5">
                    ...
                    <div class="col-10">
                        ...
                        <div class="row m-2 my-5">
                            ...
                            <h5 class="text-center">Question Length</h5>
                        </div>
